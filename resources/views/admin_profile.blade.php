...
@if(isset($adminInfo))
            ...
            <div class="col-sm-3">
                <div class="card" style="background-color: #bc7dd1;">
                    ...
                    @php
                       ...
                       $sql="SELECT * FROM driver WHERE user='DRIVER'";
                       $data=$conn-> query($sql);
                       $count=0;
                       if ($data-> num_rows > 0){
                           while ($result=$data-> fetch_assoc()) {
    ...
    <div id="main-content" class="container allContent-section py-4">
        <div class="row">
            ...
            <div class="col-sm-3">
                <div class="card" style="background-color: #e0c31d;">
                <i class="fa fa-copy" style="font-size: 70px; color:#fff;"></i>
                    <h4 style="color:white;">Driver Request</h4>
                    <h5 style="color:white;">
                    @php
                        $sql="SELECT * from driver WHERE 'user'='PENDING'";
                        $data=$conn-> query($sql);
                        $count=0;
                        if ($data-> num_rows > 0){
                            while ($result=$data-> fetch_assoc()) {
