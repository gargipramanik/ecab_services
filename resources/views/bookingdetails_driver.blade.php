        ...
        <div class="contanier">
            <div class="card">
                ...
                <nav class="navbar navbar-expand-lg bg-light">
                    ...
                    @if(isset($driveInfo))
                    @foreach($driveInfo->all() as $bookdata)
                    <div class="card-subtitle mb-2 text-muted">
                        @csrf
                        <div class="row">
                            <div class="col">
                            ...
                            <div class="col">
                                @if($bookdata->payment=="Paid")
                                    <span style="color:green"><b>{{$bookdata->payment}}</b></span>
                                @endif
                                @if($bookdata->payment=="PENDING")
                                <a href="{{url('/payment_confirm')}}{{$bookdata->id}}"><input type="button" class="btn btn-lg btn-outline-success" value="Paid"></a>
                                @endif
                            </div>
                        </div>
                        <hr>
