...
<!--========================================================================NAVBAR-START===========================================================================-->
	<header> 
		...
		&nbsp;&nbsp;<img src="{{$data->profile}}" alt="" width="60px" height="60px">
          ...
          <h4>Welcome</h4><h3>&nbsp;{{$data->fname}},</h3>
		    ...
		    <div class="collapse navbar-collapse" id="navbarSupportedContent">
		      <ul class="navbar-nav ms-auto mb-2 mb-lg-0 navbar-text navbar-brands">
		        <li class="nav-item">
		          <a class="nav-link active ms-4" aria-current="page" href="{{url('/driver_profile')}}">Home</a>
		        </li>
		        <li class="nav-item">
		          <a class="nav-link ms-4" href="{{url('/messages_driver')}}">Messages</a>
		        </li>	
                <li class="nav-item">
		          <a class="nav-link ms-4" href="{{url('/logout_driver')}}">Logout</a>
		        </li>	        
		      </ul>
		    </div>
		  </div>
