    ...
    <hr class="mb-5">           
        <div class="card card-outline-secondary" style="margin-top: 20px;">
            <div class="card-header">
                <h3 class="mb-0"><a href="{{ url()->previous() }}"><button style="border: none;"><i class="fa-solid fa-arrow-left"></i></button></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Reply User</h3>
            </div>
            <div class="card-body">
                    @if(isset($queryInfo))
                    ...
                    @endif
                    <form class="d-flex" action="{{url('/reply_send')}}" method="post">
                        @csrf
                        <input type="hidden" name="id" value="{{$data->id}}">
                        <input class="form-control" type="text" placeholder="Reply" aria-label="" name="reply">
                        <button class="btn btn-outline-success" type="submit" style="border: none;"><i class="fa-regular fa-paper-plane"></i></button>
                    </form>
                    @endforeach
                    @endif
            </div>
