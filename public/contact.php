<?php
    ...
    if(isset($_REQUEST['submit'])){
        ...
        if($data){
            ?>
            <nav style="background-color:green; color: white; width: 100%; padding-top:20px; padding-bottom:20px; height: 20px; text-align: center; font-size:large;"><?php echo "Query Posted";?><nav> 
            <?php
        }
        else{
            ?>
            <nav style="background-color:red; color: white; width: 100%; padding-top:20px; padding-bottom:20px; height: 20px; text-align: center; font-size:large;"><?php echo "Some problem occured. Please try sometimes later!";?><nav>
            <?php
        }
    }
?>
         ...
         <div class="col-lg-4 col-sm-8">
            <div class="item">
               ...
               <p>Office No 105 G&amp;E, 1st Floor,<br>
                  Marwah Complex, Opp.Tata Power SED,<br>
                  Off Sakivihar Road, Krishnalal Marwah Marg, <br> Sakinaka, Andheri (E), Mumbai - 400072
               </p>
            </div>
         </div>
         <div class="col-lg-4 col-sm-8">
            <div class="item">
               ...
               <p>+91 &nbsp;720 &nbsp;887&nbsp; 8771</p>
                ...
                <p>Working Hours - 10:00 AM - 07:00 PM</p>
            </div>
         </div>
      </div>
   </div>
	  ...
	  <div class="row row-cols-2">
	    <div class="col"><div class="right_cont_form">
            ...
            <form method="post" id="send_enquiry">
               ...
               <input type="number" id="number" name="number" required style="width: 100%;">
