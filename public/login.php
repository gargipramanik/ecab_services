...
<div class="right_cont1_form">
    ...
    <form method="post" id="send_enquiry">
        ...
        <hr color="white">
        <a href="register.php"><input type="button" class="form-control btn btn-outline-warning" value="Register"></a><p>
        <p><a href="driverLogin.php"><input type="button" class="form-control btn btn-outline-warning" value="Driver Login"></a></p>
    </form>
</div>
</div>
