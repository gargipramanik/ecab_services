...
<!--========================================================================NAVBAR-START===========================================================================-->
	<header> 
		...
		&nbsp;&nbsp;<img src="<?php echo $result['profile']; ?>" alt="" width="60px" height="60px">
		  <div class="container-fluid">
          <h4>Welcome</h4><h3>&nbsp;<?php echo $result['fname']; ?>,</h3>
		    ...
		    <div class="collapse navbar-collapse" id="navbarSupportedContent">
		      <ul class="navbar-nav ms-auto mb-2 mb-lg-0 navbar-text navbar-brands">
		        <li class="nav-item">
		          <a class="nav-link active ms-4" aria-current="page" href="user_profile.php">Home</a>
		        </li>
		        <li class="nav-item">
		          <a class="nav-link ms-4" href="">Feedback</a>
		        </li>	
                <li class="nav-item">
		          <a class="nav-link ms-4" href="">Logout</a>
		        </li>	        
		      </ul>
		    </div>
		  </div>
