	...
	if ($total) {
		if($result['auth']!=0){
            ...
            if ($result['user']=='DRIVER'){
                ...
                echo "<script>window.location.href='driver_profile.php'</script>";
            }
		}
    }
	else{
...
<body>
    ...
    <div class="hero-image-about"><img src="Images/about/about1.jpg" width="100%" height="320px" >
        <div class="hero-text">
            <h1 style="font-size:50px; padding-left: 50px">Driver Login</h1>
            <div class="container">
                <nav aria-label="breadcrumb">
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="home.php" style="padding-left: 50px;">Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Driver Login</li>
                    </ul>
                </nav>
            </div>
        </div>
...
<div class="right_cont1_form">
    ...
    <form method="post" id="send_enquiry">
        ...
        <hr color="white">
        <a href="driverRegister.php"><input type="button" class="form-control btn btn-outline-warning" value="Join with us!"></a><p>
    </form>
</div>
</div>
